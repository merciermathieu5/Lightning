/* Harnais de validation — Lightning de Tampa Bay (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'TAMPABAY',
  taille: 23,
  echantillon: {nom: 'Fabian Lysell', salaire: 900000, ct: 0, ov: 77},
  masseSousContrat: 59750000,
  nbSousContrat: 10,
  dateSecours: '8 juillet 2026',
  nbEchus: 13,
  nbBackups: 0,
  masseTotale: 96250000
};
...
(async () => {
  ...
  W.localStorage.removeItem('tbl_resignatures_v1');
  W.localStorage.removeItem('tbl_transac_v1');
